...
exports.StoryController = exports.editFileName = void 0;
const common_1 = require("@nestjs/common");
const class_validator_1 = require("class-validator");
const uuid_1 = require("uuid");
const store_story_dto_1 = require("../dto/story-content/store-story.dto");
const update_story_dto_1 = require("../dto/story-content/update-story.dto");
...
let StoryController = class StoryController {
    ...
    async store(data, _, res) {
        try {
            let story = new store_story_dto_1.StoreStoryDto();
    ...
    async update(data, _, res, uid) {
        try {
            let story = new update_story_dto_1.UpdateStoryDto();
            story.content = data.content;
            story.uid_content_type = data.uid_content_type;
            story.background_color = data.background_color;
            story.is_background_color = data.is_background_color;
...
], StoryController.prototype, "all", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [store_story_dto_1.StoreStoryDto, Object, Object]),
    __metadata("design:returntype", Promise)
], StoryController.prototype, "store", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [update_story_dto_1.UpdateStoryDto, Object, Object, String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object, String]),
    __metadata("design:returntype", Promise)
], StoryController.prototype, "deleteStoryViewContent", null);
__decorate([
...
], StoryController.prototype, "uploadFile", null);
